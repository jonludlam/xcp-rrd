...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7799bd36378e19c56477103eda86962c) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Rrd"; "Rrd_unix"; "Updates"; "Utils"; "Fring"];
                      lib_pack = true;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "rewrite.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "@\138\144\184R\129AVW\131$J[\130n\217";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
